...
_MIGRATED_COLUMNS: tuple[tuple[str, str, str], ...] = (
    ...
    ('conflicts', 'conflict_type', "TEXT NOT NULL DEFAULT 'needs_verification'"),
    ('conflicts', 'reason', "TEXT NOT NULL DEFAULT ''"),
    ('conflicts', 'confidence', "TEXT NOT NULL DEFAULT 'medium'"),
